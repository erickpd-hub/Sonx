...
export function CommentsSection({ postId, user, isDark }: CommentsSectionProps) {
    ...
    return (
        <div className="flex flex-col h-full">
            <div className={`p-4 border-b-4 ${isDark ? 'border-white' : 'border-black'} ${isDark ? 'bg-[var(--color-dark-surface)]' : 'bg-white'}`}>
